...
public class ConstructionSiteService {
    ...
    public ConstructionSiteService(StatusHistoryRepository statusHistoryRepository) {
        this.statusHistoryRepository = statusHistoryRepository;
    }

    public void recordChange(ConstructionSite constructionSite, ConstructionSiteState previousState, ConstructionSiteState newState) {
